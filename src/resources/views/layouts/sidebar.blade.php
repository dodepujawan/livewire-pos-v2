<div>
    ...
    >
            ...
            <div class="relative flex items-start justify-between gap-2">
                <div class="flex items-center gap-3 min-w-0">
                    ...
                    <div class="min-w-0 leading-tight">
                        ...
                        <div class="text-[10px] text-slate-400 truncate mt-0.5">PT Lintas Anugrah</div>
                    </div>
                </div>
        ...
        <div class="shrink-0 p-3 border-t border-white/10">
            <div class="rounded-xl bg-white/5 border border-white/10 px-3 py-2.5 flex items-center gap-3">
                <div class="shrink-0 flex h-9 w-9 items-center justify-center rounded-lg
                            bg-gradient-to-br from-amber-400/30 to-amber-600/10
                            border border-amber-400/25 text-amber-300 text-sm font-bold">
